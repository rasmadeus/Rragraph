...
protected Q_SLOTS:
    void setAbscissTitle(QString title);
    void setOrdinateTitle(QString title);
    void setAbscissMin(double value);
    void setAbscissMax(double value);
    void setAbscissStep(double value);
    void setOrdinateMin(double value);
    void setOrdinateMax(double value);
    void setOrdinateStep(double value);
public Q_SLOTS:
    void createAxesIntervalChangedSignal();
public:
    static QString getNameLegendPosition(int i);
    static QIcon getIconLegendPosition(int i);
};
